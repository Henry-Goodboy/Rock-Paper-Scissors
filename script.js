...
function playerSelection() {
    ...
    userInput = rawUserInput.charAt(0).toUpperCase() + rawUserInput.slice(1).toLowerCase();
    return userInput;
}
...
console.log(`You picked: ${ userInput } and the Computer picked: ${ computerSelection }`);
